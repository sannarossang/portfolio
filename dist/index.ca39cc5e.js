...
var _gitService = require("./services/gitService");
...
function createHtml(projects) {
    let myGitProjects = document.getElementById("myGitProjects");
...
},{"./services/gitService":"isuOd"}],"isuOd":[function(require,module,exports) {
...
function getRepos() {
    return (0, _axiosDefault.default).get("https://api.github.com/users/sannarossang/repos").then((response)=>{
